        ...
        children: [
          ...
          PremiumCard(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Text(
                'Use 3–4 for stable mobile data. Use 5–6 on strong Wi‑Fi for big carousels and batches.',
          ...
          const PremiumCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              _PanelTitle(icon: Icons.workspace_premium_rounded, title: 'About Clipora', subtitle: 'Version 0.7.15 • full-height pages + animated neon launch'),
              SizedBox(height: 12),
