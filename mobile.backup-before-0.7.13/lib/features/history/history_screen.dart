        ...
        Padding(
          ...
          child: Row(children: [
            const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Library', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900)),
              Text('Saved clips and completed jobs', style: TextStyle(color: Colors.white60)),
            ])),
                  ...
                  child: Padding(
                    ...
                    child: PremiumCard(
                      child: Column(mainAxisSize: MainAxisSize.min, children: const [
                        ...
                        SizedBox(height: 6),
                        Text('Saved videos, photos and failed jobs will appear here.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white60)),
                      ]),
                    ),
                  ),
                )
