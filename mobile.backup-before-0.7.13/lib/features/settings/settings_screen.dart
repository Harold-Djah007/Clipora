  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: ListView(
        ...
        children: [
          const Text('Control Center', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900)),
          const Text('Speed, background saving, privacy and filenames', style: TextStyle(color: Colors.white60)),
          const SizedBox(height: 22),
          PremiumCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Fast downloads', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
              const SizedBox(height: 8),
              Text('Parallel media downloads: ${s.maxConcurrentDownloads}', style: const TextStyle(color: Colors.white70)),
              Slider(
                min: 1,
                max: 6,
                divisions: 5,
              ...
              const Text(
                'Higher values are faster for carousels and batches. Keep 3–4 for stable mobile data; use 5–6 on strong Wi‑Fi.',
          ...
          PremiumCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Filenames and captions', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
          ...
          PremiumCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Private session', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
              const SizedBox(height: 8),
              SwitchListTile.adaptive(
                contentPadding: EdgeInsets.zero,
          ...
          const PremiumCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Clipora Pro', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
              SizedBox(height: 8),
              Text('Version 0.7.12 • background service + speed queue', style: TextStyle(color: Colors.white60)),
              SizedBox(height: 10),
              Text('Clipora is designed for media you own or are already authorized to view. It does not unlock private accounts or bypass Threads access controls.', style: TextStyle(color: Colors.white70)),
            ]),
          ),
        ],
      ),
