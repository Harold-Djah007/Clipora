...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://www.threads.com/share/short123", Platform.THREADS),
        ("https://l.threads.net/@creator/post/ABC123", Platform.THREADS),
        ...
        ("https://fb.me/abc123", Platform.FACEBOOK),
        ("https://www.pinterest.co.uk/pin/123/", Platform.PINTEREST),
